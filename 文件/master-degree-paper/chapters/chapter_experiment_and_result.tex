...
\section{實驗結果}
    ...
    \cref{tab:MNIST-pictures}、\cref{tab:coloredMNIST-pictures}、\cref{tab:coloredFashionMNIST-pictures}的符號意義：
    \begin{description}
...
\section{實驗分析}
    ...
    我們稱加深後的模型為Deep-SFM，而在\cref{chapter:ColoredModel}的模型在本節稱為Normal-SFM。
