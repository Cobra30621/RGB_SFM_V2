...
\def\degree    {碩士} % 碩士/博士
\def\titleZh   {一種以卷積神經網路為基礎的具可解釋性的深度學習模型}   % Chinese title
\def\titleEn   {A CNN-based Interpretable Deep Learning Model} % English title
...
\def\keywordsZh{可解釋的人工智慧, 深度學習, 視覺皮質, 自我組織特徵映射, 影像分類}
\def\keywordsEn{Explainable Artificial Intelligence, Deep Learning, Visual Cortex, Self-Organizing Maps, Image Classification}
