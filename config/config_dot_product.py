...
arch = {
    ...
    "args":{
       "in_channels": 3,
        ...
        "strides": [4, 1, 1],
        "paddings": [0, 0, 0],
        # conv_method:  "cdist", "dot_product" "squared_cdist"
        # "conv_method" : [["none", "cdist", "cdist"], ["cdist", "cdist", "cdist"]],
        "conv_method" : [["none", "dot_product", "dot_product"], ["dot_product", "dot_product", "dot_product"]],
        "initial": [["none", "kaiming", "kaiming"], ["kaiming", "kaiming", "kaiming"]],
        # "initial": [["none", "kaiming", "kaiming"], ["kaiming", "kaiming", "kaiming"]],
        # "initial": [["none", "uniform", "uniform"], ["uniform", "uniform", "uniform"]],
        "rbfs": [[["triangle", 'cReLU_percent'], ['sigmoid', 'cReLU_percent'], ['sigmoid', 'cReLU_percent']],
                 [['sigmoid', 'cReLU_percent'], ['sigmoid', 'cReLU_percent'], ['sigmoid', 'cReLU_percent']]],
        # "rbfs": [[["triangle", 'cReLU_percent'], ['cReLU_percent'], ['cReLU_percent']],
        #          [['cReLU_percent'], ['cReLU_percent'], ['cReLU_percent']]],
        ...
        "activate_params": [[[1, 0.3], [4, 0.4], [6, 0.5]], [[4, 0.3], [6, 0.4], [8, 0.5]]],
        "fc_input": 1850 * 1 * 3,
        "device": device
...
config = {
    ...
    "optimizer": optimizer,
    "loss_fn": 'CustomLoss', # 'CustomLoss', # 'CustomLoss' "CrossEntropyLoss"
